...
\code{plotly::ggplotly}. Additional clean-up and correction for
...
argument \code{e1}, borrowing \pkg{ggplot2}'s extensibility. Similarly,
if we are adding \pkg{plotly} interactive components, the \code{plotly}
object from the output \code{p} will be used instead.
